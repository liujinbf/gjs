...
def test_apply_external_signal_context_accepts_snapshot_item_objects():
    snapshot = {
        "status_tone": "success",
        "event_risk_mode": "normal",
        "summary_text": "出手分级：可轻仓试仓。结构相对干净，可作为候选机会。",
...
def test_apply_external_signal_context_accepts_event_feed_item_objects():
    snapshot = {
        "status_tone": "success",
        "event_risk_mode": "normal",
        "summary_text": "出手分级：可轻仓试仓。结构相对干净，可作为候选机会。",
...
def test_apply_external_signal_context_accepts_macro_data_item_objects():
    snapshot = {
        "status_tone": "success",
        "event_risk_mode": "normal",
        "summary_text": "出手分级：可轻仓试仓。结构相对干净，可作为候选机会。",
...
def test_apply_external_signal_context_accepts_macro_news_item_objects():
    snapshot = {
        "status_tone": "success",
        "event_risk_mode": "normal",
        "summary_text": "出手分级：可轻仓试仓。结构相对干净，可作为候选机会。",
