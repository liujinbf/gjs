...
from alert_history_store import _parse_occurred_at, read_full_history
...
def summarize_recent_history(days: int = 7, history_file: Path | None = None, now: datetime | None = None) -> dict:
    ...
    counts = {"spread": 0, "recovery": 0, "macro": 0, "session": 0, "mt5": 0}
    ...
    summary_text = (
        ...
        f"点差异常 {counts['spread']} 条，点差恢复 {counts['recovery']} 条，宏观提醒 {counts['macro']} 条，"
